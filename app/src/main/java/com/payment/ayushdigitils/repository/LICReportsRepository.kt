...
import com.payment.ayushdigitils.ui.fragments.report.lic_report.LICReportPagingSource

class LICReportsRepository(
    private val apiService: PayApiServices
) {

    fun fetchLICReportsResults(
        user_id: String?,
        apptoken: String,
        searchtext: String?,
        status: String?,
