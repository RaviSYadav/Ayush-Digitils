package com.payment.ayushdigitils.ui.fragments.report.aeps_wallet
...
import com.payment.ayushdigitils.ui.fragments.report.main_wallet.MainWalletReportsAdapter
...
class AepsWalletReportFragment : BaseFragment(R.layout.fragment_aeps_report), AepsWalletReportsAdapter.OnReportClickListener, FiltersFragment.FiltersDialogListener {
    ...
    private lateinit  var reportsAdapter: AepsWalletReportsAdapter
    ...
    override fun initView() {
        observer()
        reportsAdapter = AepsWalletReportsAdapter(this)
