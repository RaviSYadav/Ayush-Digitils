...
class BillReportsPagingAdapter(private val listener: OnReportClickListener): PagingDataAdapter<RechargeReportData, BillReportsPagingAdapter.TrackViewHolder>(TrackComparator) {
