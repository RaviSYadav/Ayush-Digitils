...
class DMTReportFragment : BaseFragment(R.layout.fragment_aeps_report),DMTReportsAdapter.OnReportClickListener , FiltersFragment.FiltersDialogListener{
    ...
    private val viewModel by viewModel<DMTReportsViewModel>()

    private lateinit  var reportsAdapter: DMTReportsAdapter
    ...
    override fun initView() {
        observer()
        reportsAdapter = DMTReportsAdapter(this)
    ...
    override fun onInvoiceClick(position: Int, reports: RechargeReportData) {
        ...
        invoiceList.add(InvoiceModel("TDS", reports.tds ?: "NA"))
        ...
        invoiceList.add(InvoiceModel("Bank", reports.option3 ?: "NA"))
