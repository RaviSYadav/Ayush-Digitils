...
class DMTReportsPagerAdapter(private val listener: OnReportClickListener): PagingDataAdapter<RechargeReportData, DMTReportsPagerAdapter.TrackViewHolder>(TrackComparator) {
