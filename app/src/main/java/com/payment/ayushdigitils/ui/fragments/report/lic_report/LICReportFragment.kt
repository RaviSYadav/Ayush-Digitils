...
class LICReportFragment : BaseFragment(R.layout.fragment_aeps_report),
    LICReportsAdapter.OnReportClickListener,
    ...
    private val viewModel by viewModel<LICReportsViewModel>()
    ...
    private lateinit var reportsAdapter: LICReportsAdapter
    ...
    override fun initView() {
        observer()
        reportsAdapter = LICReportsAdapter(this)
    ...
    override fun onInvoiceClick(position: Int, reports: RechargeReportData) {
        ...
        invoiceList.add(InvoiceModel("Name", reports.username ?: "NA"))
        invoiceList.add(InvoiceModel("Policy Number", reports.number ?: "NA"))
        invoiceList.add(InvoiceModel("Description", reports.description ?: "NA"))
        invoiceList.add(
            InvoiceModel(
                "Amount",
                getString(R.string.remitter_full_name, getString(R.string.Rs), reports.amount)
            )
        )
        invoiceList.add(
            InvoiceModel(
        ...
        invoiceList.add(InvoiceModel("GST", reports.gst ?: "NA"))
        invoiceList.add(InvoiceModel("Remark", reports.remark ?: "NA"))
        invoiceList.add(InvoiceModel("Rtype", reports.rtype ?: "NA"))
        invoiceList.add(InvoiceModel("Via", reports.via ?: "NA"))
        invoiceList.add(InvoiceModel("Trans Type", reports.trans_type ?: "NA"))
        invoiceList.add(InvoiceModel("Created At", reports.created_at ?: "NA"))
        invoiceList.add(InvoiceModel("Status", reports.status ?: "NA"))

        invoiceViewModel.setInvoiceList(invoiceList)

        val action =
            NavGraphInvoiceDirections.actionGlobalInvoiceFragment(reports.status ?: "success", "")
