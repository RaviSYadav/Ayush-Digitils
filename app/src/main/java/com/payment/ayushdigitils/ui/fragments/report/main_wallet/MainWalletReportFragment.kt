...
class MainWalletReportFragment : BaseFragment(R.layout.fragment_aeps_report), MainWalletReportsAdapter.OnReportClickListener, FiltersFragment.FiltersDialogListener {
    ...
    private lateinit  var reportsAdapter: MainWalletReportsAdapter
    ...
    override fun initView() {
        observer()
        reportsAdapter = MainWalletReportsAdapter(this)
