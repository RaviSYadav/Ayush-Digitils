...
class MATMFundReportsPagingAdapter(private val listener: OnReportClickListener): PagingDataAdapter<RechargeReportData, MATMFundReportsPagingAdapter.TrackViewHolder>(TrackComparator) {
