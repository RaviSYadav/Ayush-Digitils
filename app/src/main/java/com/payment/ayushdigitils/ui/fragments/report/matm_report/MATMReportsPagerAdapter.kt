...
class MATMReportsPagerAdapter(private val listener: OnReportClickListener): PagingDataAdapter<RechargeReportData, MATMReportsPagerAdapter.TrackViewHolder>(TrackComparator) {
