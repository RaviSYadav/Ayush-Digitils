...
class NSDLReportsAdapter(private val listener: OnReportClickListener): PagingDataAdapter<RechargeReportData, NSDLReportsAdapter.TrackViewHolder>(TrackComparator) {
