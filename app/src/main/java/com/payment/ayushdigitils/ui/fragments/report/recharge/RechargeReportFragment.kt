...
class RechargeReportFragment : BaseFragment(R.layout.fragment_aeps_report),
    RechargeReportsAdapter.OnReportClickListener, FiltersFragment.FiltersDialogListener {
    ...
    private val viewModel by viewModel<RechargeReportsViewModel>()
    ...
    private lateinit var reportsAdapter: RechargeReportsAdapter
    ...
    override fun initView() {
        observer()
        reportsAdapter = RechargeReportsAdapter(this)
    ...
    override fun onInvoiceClick(position: Int, reports: RechargeReportData) {
        ...
        invoiceList.add(
            InvoiceModel(
                "Balance",
                getString(R.string.remitter_full_name, getString(R.string.Rs), reports.balance)
            )
        )
        invoiceList.add(
            InvoiceModel(
                "Profit",
                getString(R.string.remitter_full_name, getString(R.string.Rs), reports.profit)
            )
        )
