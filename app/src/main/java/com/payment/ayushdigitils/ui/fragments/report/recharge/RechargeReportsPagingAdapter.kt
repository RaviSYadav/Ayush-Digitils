...
class RechargeReportsPagingAdapter(private val listener: OnReportClickListener): PagingDataAdapter<RechargeReportData, RechargeReportsPagingAdapter.TrackViewHolder>(TrackComparator) {
