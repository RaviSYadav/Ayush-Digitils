...
class WalletReportsPagerAdapter(private val listener: OnReportClickListener): PagingDataAdapter<RechargeReportData, WalletReportsPagerAdapter.TrackViewHolder>(TrackComparator) {
